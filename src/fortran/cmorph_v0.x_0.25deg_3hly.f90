...
!
! All units are "mm" and represent the precipitation total for the 3-hour
! period.  Missing data are denoted by values of "-9999."
...
! 
! Below is FORTRAN 90 code that will read the data sets:
!
!------------------------------------------------------------------

      PROGRAM cmorph_v0_x_0_25deg_3hly
...
!------------------------------------------------------------------
      ...
      END PROGRAM cmorph_v0_x_0_25deg_3hly
